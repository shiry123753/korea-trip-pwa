  ...
  },
  {
    ...
    spots: [
      ...
      },
      {
        ...
        timeSlot: '17:45',
        durationMin: 60,
        note: '釜山最著名的海水浴場，海邊散步',
        desc: '釜山最具代表性的海水浴場，綿延的白沙灘與遼闊海景，是海雲台一帶的地標，適合傍晚散步、看海。',
      },
      {
        id: 'the-bay-101',
  ...
  },
  {
    ...
    spots: [
      ...
      },
      {
        ...
        durationMin: 120,
        note: '韓國品牌、免稅購物',
        desc: '釜山最大型購物中心之一，匯聚韓國本土品牌、國際精品與免稅店。是購物衝刺的好去處，記得留意結帳時間。',
      },
      {
        id: 'hotel-hyatt-d3',
        name: '前往凱悅嘉軒（附近晚餐）',
        ...
        durationMin: 0,
        note: '入住新飯店，於附近用晚餐',
        desc: '釜山延山凱悅嘉軒飯店（Hyatt Place Busan Yeonsan）。入住後於飯店附近用晚餐、自由活動。',
        isHotel: true,
      },
    ],
  },
  {
    ...
    spots: [
      ...
      },
      {
        ...
        timeSlot: '15:00',
        durationMin: 60,
        note: '每人一杯椪糖拿鐵，含椪糖 DIY 體驗',
        desc: '以古代加耶王國文化為主題的樂園，安排椪糖（달고나）體驗，親手製作韓劇《魷魚遊戲》同款造型椪糖，每人另贈一杯椪糖拿鐵。',
      },
      {
        id: 'canned-market',
        name: '罐頭市場',
        emoji: '🛍️',
        address: '부산 중구 중구로33번길',
        timeSlot: '16:30',
        durationMin: 90,
        note: '新增景點：富平罐頭市場（부평깡통시장）',
        desc: '釜山知名的傳統市場，以進口罐頭、乾貨與各式道地小吃聞名，是南浦洞一帶必逛的老市場。',
      },
      {
        id: 'hotel-hyatt-d4',
        name: '回飯店（凱悅嘉軒）',
